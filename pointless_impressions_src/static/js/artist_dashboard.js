(() => {
  // pointless_impressions_src/theme/static_src/src/js/artist_dashboard.js
  document.addEventListener("DOMContentLoaded", function() {
    ...
    document.querySelectorAll(".js-edit-artwork-btn").forEach((button) => {
      button.addEventListener("click", function() {
        ...
        fetch(`/api/artworks/${artworkId}/`).then((response) => response.json()).then((data) => {
...
//# sourceMappingURL=artist_dashboard.js.map
