  ...
  function renderArtworkList(artworks) {
    ...
    if (artworks.length === 0) {
      ...
      artworks.forEach((artwork) => {
        ...
        const artistLine = artwork.artist && artwork.artist.user_profile && artwork.artist.user_profile.user && artwork.artist.user_profile.user.username ? `<p class="text-sm -mt-2 mb-2">
