...
- For Cloudinary integration I used [Cloudinary Django Documentation](https://cloudinary.com/documentation/python_quickstart)
...
- To help with SSR and API for fetching artwork, blog and profile information quickly and efficiently I used [Django REST Framework Documentation](https://www.django-rest-framework.org/)
...
- Writing Behave tests using behave-django I used [Behave-Django Documentation](https://behave-django.readthedocs.io/en/latest/)
- Writing TestCase tests for Django I used [Django Testing Documentation](https://docs.djangoproject.com/en/5.2/topics/testing/)
...
- To help with sorting via SSR and AJAX via API I used [BugBytes - Django Ajax Requests, HTMX & CSRF Tokens](https://www.youtube.com/watch?v=lc1sOvRaFpg&t=663s)
- To set up autcomplete search I used tarekraafat/autocomplete.js library from [GitHub - tarekraafat/autocomplete.js: A simple, lightweight, pure vanilla JavaScript autocomplete library.](https://tarekraafat.github.io/autoComplete.js/#/)
