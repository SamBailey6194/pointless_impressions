...
- Integrating Square for payments I used [Square Payments API Documentation](https://developer.squareup.com/docs/payments-api/overview) and [Square Payment Integration with Django by JustDjango](https://www.youtube.com/watch?v=Z3Z8h6_2b0M)
